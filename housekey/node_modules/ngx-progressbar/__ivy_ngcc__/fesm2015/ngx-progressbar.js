...
function NgProgressComponent_ng_container_0_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵstyleProp("box-shadow", "0 0 10px " + ctx_r265.color + ", 0 0 5px " + ctx_r265.color);
} }
function NgProgressComponent_ng_container_0_div_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵstyleProp("border-top-color", ctx_r266.color)("border-left-color", ctx_r266.color);
} }
function NgProgressComponent_ng_container_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const state_r264 = ctx.$implicit;
    const ctx_r263 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵstyleProp("transition", "opacity " + ctx_r263.speed + "ms " + ctx_r263.ease);
    ɵngcc0.ɵɵattribute("active", state_r264.active);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵstyleProp("transform", state_r264.transform)("background-color", ctx_r263.color)("transition", state_r264.active ? "all " + ctx_r263.speed + "ms " + ctx_r263.ease : "none");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r263.meteor);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r263.spinner);
} }
class NgProgressRef {
    /**
     * @param {?} customConfig
