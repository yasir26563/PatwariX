...
export class PropertyItemComponent implements OnInit {
  ...
  constructor(public appSettings: AppSettings, public appService: AppService, public MyHttp: HttpClient, private route: ActivatedRoute) {
  ...
  public sendid() {
    ...
    return this.MyHttp.get("http://localhost:3000/").subscribe(DBinfo => this.proptitle = DBinfo[0].id,
      err => console.log(err),
      () => console.log(this.proptitle[0].id));
  }

  // public UpdateContact() {
  //   console.log("Function Called")
  //   return this.MyHttp.get("http://localhost:3000/").subscribe(DBinfo => this.proptitle = DBinfo,
  //     err => console.log(err),
  //     () => console.log(this.proptitle));
  // }
