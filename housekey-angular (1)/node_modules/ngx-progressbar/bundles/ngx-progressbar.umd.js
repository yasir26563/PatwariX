    ...
    ***************************************************************************** */
    ...
    var NgProgressRef = /** @class */ (function () {
        function NgProgressRef(customConfig, _onDestroyCallback) {
            ...
            this.started = this._started.pipe(operators.filter((/**
             * @return {?}
             */
            ...
            this.completed = this._completed.pipe(operators.filter((/**
             * @return {?}
             */
            function () { return _this.isStarted; })));
    ...
    var NgProgress = /** @class */ (function () {
        ...
        /** @nocollapse */ NgProgress.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function NgProgress_Factory() { return new NgProgress(core.ɵɵinject(NG_PROGRESS_CONFIG, 8)); }, token: NgProgress, providedIn: "root" });
        return NgProgress;
    }());
    if (false) {
        /**
